...
AjaxBootstrapSelectList.prototype.build = function (data) {
    ...
    $select.append("<optgroup label='Options'><option value='-1'>Ajouter et modifier</option></optgroup>");
    $select.append("<optgroup label=''><option value='-2'>Rechercher</option></optgroup>");
